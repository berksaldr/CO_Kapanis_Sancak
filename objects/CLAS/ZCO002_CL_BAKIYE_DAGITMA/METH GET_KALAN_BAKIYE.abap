  METHOD get_kalan_bakiye.
    ...
    SELECT i~costcenter,
         ...
         WHERE i~ledger EQ '0L'
           ...
           AND cs~costcentercategory EQ 'E'
...
*    lv_endda -= 1.
    ...
    fiscalperiodenddate
    FROM i_fiscalperiodforvariant WITH PRIVILEGED ACCESS AS fiscperiod
    WHERE fiscalyearperiod = @iv_period
      AND fiscalyearvariant = 'K0'
    INTO @DATA(ls_fiscperiod).

    lv_begda = ls_fiscperiod-fiscalperiodstartdate.
    lv_endda = ls_fiscperiod-fiscalperiodenddate.
